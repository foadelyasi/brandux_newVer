...
<div>
    ...
    <div class="page-content">
        ...
        <section>
            <div class="container">
                <form action="{{route('pay')}}" method="get" class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>آدرس</label>
                                        <textarea name="address" class="form-group" placeholder="استان...شهر...منطقه...کوچه...پلاک"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-md-0">
                                        <label>کد پستی</label>
                                        <input name="post_code" type="text" id="zippostalcode" class="form-control" placeholder=" کد پستی">
                                    </div>
                                </div>
                            </div>
                        </div>
