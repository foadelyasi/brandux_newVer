...
<head>
    ...
    <link rel="stylesheet" src="/assets/css/slick.css" type="text/css" media="all" />
    <link rel="stylesheet" src="/assets/css/slick-theme.css" type="text/css" media="all" />

    <link rel="stylesheet" src="/assets/css/jquery-ui.css" type="text/css" media="all" />

    <link rel="stylesheet" src="/assets/css/jquery.timepicker.min.css" type="text/css" media="all" />

    <link rel="stylesheet" src="/assets/css/meanmenu.min.css" type="text/css" media="all" />

    <link rel="stylesheet" src="/assets/css/magnific-popup.min.css" type="text/css" media="all" />

    <link rel='stylesheet' src='/assets/css/icofont.min.css' type="text/css" media="all" />

    <link rel='stylesheet' src='/assets/css/flaticon.css' type="text/css" media="all" />

    <link rel='stylesheet' src='/assets/css/settings.css' type="text/css" media="all" />
    <link rel='stylesheet' src="/assets/css/layers.css" type="text/css" media="all" />
    <link rel='stylesheet' src="/assets/css/navigation.css" type="text/css" media="all" />

    <link rel='stylesheet' src="/assets/css/jquery-jvectormap-2.0.5.css" type="text/css" media="all" />

    <link rel="stylesheet" src="/assets/css/style.css" type="text/css" media="all" />

    <link rel="stylesheet" src="/assets/css/responsive.css" type="text/css" media="all" />

    <link rel="stylesheet" src="/assets/css/rtl.css" type="text/css" media="all" /><link href="fonts.css@ver=5.6.2.css" rel="stylesheet" />
    <!--[if IE]>
                    ...
                    <nav class="navbar navbar-expand-md navbar-light">
                        ...
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            <ul class="navbar-nav ms-auto">
                                <li class="nav-item">
                                    <a href="#" class="nav-link dropdown-toggle active">صفجه اصلی</a>
                                ...
                                <li class="nav-item">
                                    <a href="menu.html" class="nav-link">منو</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="#" class="nav-link dropdown-toggle">وبلاگ</a>
                                    <ul class="dropdown-menu">
                                        <li class="nav-item">
                                                    ...
                                                    <div class="authentication-action mb-20">
                                                        ...
                                                        <div class="authentication-action-item">
                                                            <div class="custom-control custom-checkbox">
                                                                ...
                                                                <label class="custom-control-label" for="check1">مرا به خاطر بسپار</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="authentication-btn">
                                                    ...
                                                    <div class="authentication-action mb-20">
                                                        <div class="authentication-action-item">
                                                            <div class="custom-control custom-checkbox">
                                                                ...
                                                                <label class="custom-control-label" for="check2">آیا با شرایط  و قوانین سایت موافق هستید ؟ <a href="privacy-policy.html">مشاهده قوانین سایت</a>.</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="authentication-btn">
        ...
        <div class="cart-modal-body">
            ...
            <div class="cart-modal-product">
                ...
                <div class="cart-modal-content">
                    <h4><a href="shop-details.html">چیکن برگر</a></h4>
                    <div class="cart-modal-action">
                        <div class="cart-modal-action-item">
                            <div class="cart-modal-quantity">
                                <p>1</p>
                                <p>x</p>
                                <p class="cart-quantity-price">20هزار</p>
                            </div>
                        </div>
                        <div class="cart-modal-action-item">
            ...
            <div class="cart-modal-product">
                ...
                <div class="cart-modal-content">
                    <h4><a href="shop-details.html">پیتزا مخصوص</a></h4>
                    <div class="cart-modal-action">
                        <div class="cart-modal-action-item">
                            <div class="cart-modal-quantity">
                                <p>1</p>
                                <p>x</p>
                                <p class="cart-quantity-price">10 هزار</p>
                            </div>
                        </div>
                        <div class="cart-modal-action-item">
                            <div class="cart-modal-delete">
            ...
            <div class="cart-modal-button">
                <a href="checkout.html" class="btn full-width">ورود به صفحه پرداخت</a>
                <a href="cart.html" class="btn btn-yellow full-width">مشاهده سبد خرید</a>
            </div>
