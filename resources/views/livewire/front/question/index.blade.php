                        ...
                        <div id="accordion2" class="accordion">
                            <div class="card border-0 active mb-2">
                                <div class="card-header border mb-0 bg-transparent">
                                    <h6 class="mb-0">
                                        <a class="text-dark" data-toggle="collapse" data-parent="#accordion2" href="#collapse4" aria-expanded="true">فرق بین پکیج های اقتصادی و پلتفرم های اختصاصی در خدمات طراحی سایت چیست؟</a>
                                    </h6>
                                </div>
                            ...
                            <div class="card border-0 mb-2">
                                <div class="card-header border mb-0 bg-transparent">
                                    <h6 class="mb-0">
                                        <a class="text-dark" data-toggle="collapse" data-parent="#accordion2" href="#collapse5">چرا قیمت های برنداکس پایین تر از دیگر گروه های طراحی است؟</a>
                                    </h6>
                                </div>
                            ...
                            <div class="card border-0">
                                <div class="card-header border mb-0 bg-transparent">
                                    <h6 class="mb-0">
                                        <a class="text-dark" data-toggle="collapse" data-parent="#accordion2" href="#collapse6">چرا برنداکس ؟</a>
                                    </h6>
                                </div>
